...
@section('content')
  ...
  <section class="pb-5">
    <div class="container position-relative mt-n5">
      <div class="row no-gutters">
        @component('ui.crossroad', [ 'roads' => $roads ?? [] ])
        @endcomponent
      </div>
    </div>
  </section>
  ...
  @if ($seating)
    @component('ui.page-section', ['white' => true])
      @slot('row_content')
        <div class="col-12">
          @include('partials.row-card-zastupitelstvo', ['heading' => true])
        </div>
      @endslot
    @endcomponent
  @endif
      ...
      @slot('row_content')
        ...
        <div class="col-12 col-md-4 col-lg-3">
          @component('ui.lonely-road', [
            ...
            'description' => __('Čo nás čaká v najbližších mesiacoch', 'rudno-theme'),
    ...
    @slot('row_content')
      ...
      <div class="col-12 col-md-4 col-lg-3">
        @component('ui.lonely-road', [
          ...
          'description' => __('Najnovšie správy zo života obce', 'rudno-theme'),
